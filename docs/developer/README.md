...
objects in the application using [django-fsm](https://github.com/viewflow/django-fsm) and [django-fsm-admin](https://github.com/gadventures/django-fsm-admin) library. See the [ADR number 15](../architecture/decisions/0015-use-django-fs.md) for more information on the topic.
