...
To manually test locally (if not mocking cloudflare):
   ...
   - Add (temporarily) that domain to the list of valid_domains in both the DomainDNSView and DomainDNSRecordsView. This will allow you to follow a link to a DNS Record page
