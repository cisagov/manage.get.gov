...
| Require expressions Alpine’s CSP build forbids? | Build our own JS | [#4408: AAAA record form PR](https://github.com/cisagov/manage.get.gov/pull/4696). Display different form labels based on another field's dropdown. |