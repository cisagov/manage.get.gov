...
# test runner and in local dev (where the registry is unreachable) so it doesn't
# spawn a long-lived greenlet per EPPLibWrapper instance; the heartbeat tests
