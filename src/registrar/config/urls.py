...
for step, view in [
    ...
    (Step.ORGANIZATION-TYPE, views.OrganizationType),
    (Step.TRIBAL-GOVERNMENT, views.TribalGovernment),
    (Step.ORGANIZATION-FEDERAL, views.OrganizationFederal),
    (Step.ORGANIZATION-ELECTION, views.OrganizationElection),
    (Step.ORGANIZATION-CONTACT, views.OrganizationContact),
    (Step.ABOUT_YOUR-ORGANIZATION, views.AboutYourOrganization),
    (Step.AUTHORIZING-OFFICIAL, views.AuthorizingOfficial),
    (Step.CURRENT-SITES, views.CurrentSites),
    (Step.DOTGOV-DOMAIN, views.DotgovDomain),
    (Step.PURPOSE, views.Purpose),
    (Step.YOUR-CONTACT, views.YourContact),
    (Step.OTHER-CONTACTS, views.OtherContacts),
    (Step.ANYTHING-ELSE, views.AnythingElse),
