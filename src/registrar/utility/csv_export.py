...
class DomainRequestDataFull(DomainRequestExport):
    ...
    def get_computed_fields(cls, delimiter=", ", **kwargs):
        ...
        computed_fields.update(
            {
                "requester_approved_domains_count": cls.get_creator_approved_domains_count_query(),
                "requester_active_requests_count": cls.get_creator_active_requests_count_query(),
