...
URL_PERMISSIONS = {
    ...
    "members": [IS_PORTFOLIO_MEMBER],
    "member": [HAS_PORTFOLIO_MEMBERS_VIEW, IS_PORTFOLIO_MEMBER_VIEWING_SELF_ONLY],
    "member-delete": [HAS_PORTFOLIO_MEMBERS_EDIT],
    "member-permissions": [HAS_PORTFOLIO_MEMBERS_EDIT],
    "member-domains": [HAS_PORTFOLIO_MEMBERS_VIEW, IS_PORTFOLIO_MEMBER_VIEWING_SELF_ONLY],
    "member-domains-edit": [HAS_PORTFOLIO_MEMBERS_EDIT],
    "invitedmember": [HAS_PORTFOLIO_MEMBERS_VIEW],
    "invitedmember-delete": [HAS_PORTFOLIO_MEMBERS_EDIT],
    "invitedmember-permissions": [HAS_PORTFOLIO_MEMBERS_EDIT],
    "invitedmember-domains": [HAS_PORTFOLIO_MEMBERS_VIEW],
