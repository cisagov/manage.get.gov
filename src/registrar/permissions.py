...
from registrar.decorators import (
    HAS_PORTFOLIO_DOMAIN_REQUESTS_ANY_PERM, IS_STAFF, IS_DOMAIN_MANAGER, IS_DOMAIN_MANAGER_AND_NOT_PORTFOLIO_MEMBER,
    IS_PORTFOLIO_MEMBER_AND_DOMAIN_MANAGER, IS_CISA_ANALYST, IS_OMB_ANALYST, 
    IS_FULL_ACCESS, IS_DOMAIN_REQUEST_CREATOR, IS_STAFF_MANAGING_DOMAIN,
    ...
    HAS_PORTFOLIO_MEMBERS_EDIT, HAS_PORTFOLIO_MEMBERS_ANY_PERM, HAS_PORTFOLIO_MEMBERS_VIEW, ALL,
)
            ...
            if url_name:
                ...
                # Check if permissions match (more complex, may need refinement)
                    ...
                    if view_permissions != mapping_permissions:
                        issues['permission_mismatch'].append(
                            (url_name, path, view_permissions, mapping_permissions)
                        )
