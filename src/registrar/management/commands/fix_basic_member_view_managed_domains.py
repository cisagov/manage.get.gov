...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--verbose',
            action='store_true',
            help='Show detailed information about each user processed'
        )
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(f"{action} {updated_count} user permissions")
        )
    ...
    def _find_members_needing_permission(self):
        ...
        return UserPortfolioPermission.objects.filter(
