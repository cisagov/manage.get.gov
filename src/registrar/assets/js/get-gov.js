...
class MembersTable extends LoadTableBase {
   ...
   */
  generateDomainsHTML(num_domains, domain_names, domain_urls, member_id) {
      ...
      fetch(url)
        ...
        .then(data => {
          ...
          data.members.forEach(member => {
            ...
            let domainsHTML = this.generateDomainsHTML(num_domains, domain_names, domain_urls, member_id);
