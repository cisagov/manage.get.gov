...
class TestDomainRequestAdmin(MockEppLib):
    ...
    def test_short_org_name_in_domain_requests_list(self):
        ...
        # of the request
        self.assertContains(response, "Federal", count=3)
        # This may be a bit more robust
        self.assertContains(response, '<a id="genericorganization-filter-federal" href="?converted_generic_orgs=federal&amp;generic_org_type__exact=federal">Federal</a>', count=1)
    ...
    def test_default_status_in_domain_requests_list(self):
        ...
        self.assertContains(response, "status in [submitted,in review,in review - omb,action needed]", count=1)
